// Core TypeScript interfaces for AI Interview Trainer
...
export interface EvaluateAnswerParams {
  ...
  answer: string;
  candidateProfile: Pick<CandidateProfile, 'name' | 'targetRole' | 'experienceLevel' | 'skills'>;
}

export interface ModelAnswerParams {
  question: InterviewQuestion;
  targetRole: string;
  experienceLevel: ExperienceLevel;
}
